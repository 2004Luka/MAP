...
export const CitySearch = ({
  ...
  return (
    <div className="animate-slide-up">
      ...
      {selectedCity ? (
        <div className="flex items-center gap-3 bg-white border border-primary-200 px-4 py-3 rounded-lg animate-scale-in text-secondary-900 dark:bg-blue-900 dark:text-white dark:border-blue-700">
          <div className="flex-1">
            <div className="font-medium text-primary-900 dark:text-blue-100">{selectedCity.name}</div>
            {selectedCity.region && (
              <div className="text-sm text-primary-600 dark:text-blue-300">{selectedCity.region}</div>
            )}
          </div>
          <button
            onClick={onCityRemove}
            className="text-primary-500 hover:text-primary-700 p-1 rounded-full hover:bg-primary-100 transition-all duration-200 dark:text-blue-300 dark:hover:text-blue-100 dark:hover:bg-blue-800"
        ...
        <div className="relative" ref={dropdownRef}>
          <input
            ...
            className="input-field bg-white border border-secondary-200 text-secondary-900 placeholder-secondary-400 focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
